...
public class EquipmentDealers 
{
	private WebDriver driver;
	private By heading = By.cssSelector("h1.hero-heading__subheading");
	private static long pageSyncTime = 60;
	private String page = "Equipment Dealers";
	
	
	public EquipmentDealers(WebDriver driver)
	{
		this.driver=driver;
	}
	public boolean verifyEquipmentDealersLabel()
	{
	...
	{		
		if(SeleniumHelper.validateUrl("equipment-dealers"))
		{
			return true;
		}
		return false;
